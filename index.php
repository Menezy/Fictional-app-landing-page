...
<title>Fictional App landing page</title>
...
<div class="navbar navbar-default navbar-fixed-top">
	<div class="container">
		...
		<div class="navbar-header">
			...
			<a href="index.html" class="navbar-brand"><span>App</span> Page</a>
		</div>
		...
		<div class="row">
               ...
               <div class="col-md-6 col-sm-7 col-xs-12">
                    <div class="home-thumb">
                         <h1 class="wow fadeInUp" data-wow-delay="0.6s">Our App  Landing Page</h1>
                         <p class="wow fadeInUp" data-wow-delay="0.8s">A fictional App landing page for a startup team</p>
     ...
     <div class="container">
          <div class="row">
               ...
               <div class="wow fadeInUp col-md-6 col-sm-12" data-wow-delay="0.4s">
                   <h2>Our Team</h2>
                   <h3 class="wow fadeInUp" data-wow-delay="0.8s">Fictional App landing page.</h3>
		...
		<div class="row">
               ...
               <div class="col-md-8 col-sm-6">
                    <div class="wow fadeInUp footer-copyright" data-wow-delay="0.4s">
                         <p>&copy;Fictional App landing page  
                    </div>
               </div>
